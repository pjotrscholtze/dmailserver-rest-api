...
func NewGetQuotaOfEmailAccountParams() GetQuotaOfEmailAccountParams {
	...
	return GetQuotaOfEmailAccountParams{}
}

// GetQuotaOfEmailAccountParams contains all the bound params for the get quota of email account operation
...
func (o *GetQuotaOfEmailAccountParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetQuotaOfEmailAccountParams) bindEmailAddress(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
