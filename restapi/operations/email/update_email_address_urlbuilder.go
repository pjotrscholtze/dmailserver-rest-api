...
func (o *UpdateEmailAddressURL) Build() (*url.URL, error) {
	...
	if emailAddress != "" {
		...
		return nil, errors.New("emailAddress is required on UpdateEmailAddressURL")
	}
...
func (o *UpdateEmailAddressURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on UpdateEmailAddressURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on UpdateEmailAddressURL")
	}
