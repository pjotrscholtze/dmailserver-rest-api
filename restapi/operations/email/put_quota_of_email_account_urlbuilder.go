...
func (o *PutQuotaOfEmailAccountURL) WithBasePath(bp string) *PutQuotaOfEmailAccountURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *PutQuotaOfEmailAccountURL) Build() (*url.URL, error) {
	...
	if emailAddress != "" {
		...
		return nil, errors.New("emailAddress is required on PutQuotaOfEmailAccountURL")
	}
...
func (o *PutQuotaOfEmailAccountURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PutQuotaOfEmailAccountURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PutQuotaOfEmailAccountURL")
	}
