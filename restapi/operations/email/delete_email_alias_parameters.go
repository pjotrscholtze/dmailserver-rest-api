...
// DeleteEmailAliasParams contains all the bound params for the delete email alias operation
...
func (o *DeleteEmailAliasParams) bindEmailAddress(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
