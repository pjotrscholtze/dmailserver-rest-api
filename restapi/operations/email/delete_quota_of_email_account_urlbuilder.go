...
func (o *DeleteQuotaOfEmailAccountURL) WithBasePath(bp string) *DeleteQuotaOfEmailAccountURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *DeleteQuotaOfEmailAccountURL) Build() (*url.URL, error) {
	...
	var _path = "/email/{emailAddress}/quota"

	emailAddress := o.EmailAddress
	if emailAddress != "" {
		_path = strings.Replace(_path, "{emailAddress}", emailAddress, -1)
	} else {
		return nil, errors.New("emailAddress is required on DeleteQuotaOfEmailAccountURL")
	}
...
func (o *DeleteQuotaOfEmailAccountURL) String() string {
...
func (o *DeleteQuotaOfEmailAccountURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteQuotaOfEmailAccountURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteQuotaOfEmailAccountURL")
	}
