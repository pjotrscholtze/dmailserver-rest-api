...
// DeleteEmailAccountParams contains all the bound params for the delete email account operation
...
func (o *DeleteEmailAccountParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *DeleteEmailAccountParams) bindEmailAddress(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
