...
func (o *GetQuotaOfEmailAccountURL) WithBasePath(bp string) *GetQuotaOfEmailAccountURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetQuotaOfEmailAccountURL) Build() (*url.URL, error) {
	...
	if emailAddress != "" {
		...
		return nil, errors.New("emailAddress is required on GetQuotaOfEmailAccountURL")
	}
...
func (o *GetQuotaOfEmailAccountURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetQuotaOfEmailAccountURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetQuotaOfEmailAccountURL")
	}
