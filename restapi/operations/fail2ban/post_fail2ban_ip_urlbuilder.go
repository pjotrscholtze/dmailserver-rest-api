...
func (o *PostFail2banIPURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PostFail2banIPURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PostFail2banIPURL")
	}
